...
function wc_slm_section($sections) {
	...
	$sections['wc_slm'] = __('Woo License Manager', 'woo-slm');
	return $sections;
...
function wc_slm_settings($settings, $current_section) {
	...
	if ($current_section == 'wc_slm') {
		...
		$settings_slm[] = array('name' => __('WooCommerce Software License Manager Settings', 'wc-slm'), 'type' => 'title', 'desc' => '', 'id' => 'wcslider');
